...
class XhsStoreFactory:
    """Factory for creating XHS store instances"""
    
    STORES = {
        "csv": XhsCsvStoreImplement,
        "json": XhsJsonStoreImplement,
        "jsonl": XhsJsonlStoreImplement,
        "mysql": XhsDbStoreImplement,
    }
    ...
    def create_store() -> AbstractStore:
        ...
        if not store_class:
            raise ValueError(
                ...
                f"Supported options: csv, json, jsonl, mysql"
            )
        return store_class()
...
async def update_xhs_note(note_item: Dict) -> bool:
    """
    ...
    Returns:
        bool: True if new note was added, False if existing note was updated
    """
    ...
    # Save to primary storage (jsonl/csv/json)
    is_new = await XhsStoreFactory.create_store().store_content(local_db_item)
    return is_new
